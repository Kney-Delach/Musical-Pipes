...
namespace LevelManagement.Data
{
    public class JsonSaver
    {
        ...
        // default filename
        private static readonly string _filename = "saveFile.sav";
        ...
        public void Load(SaveData data)
        {
            ...
            if (File.Exists(loadFilename))
            {
                using (StreamReader reader = new StreamReader(loadFilename))
                {
                    ...
                    //MainMenu.Instance.SetDebugString("Json File Value: " + json + " ##### Data Value: " + data.fullScreenIndex + " # " + data.masterVolume + " # " + data.musicVolume + " # " + data.sfxVolume);
            ...
            {
                //MainMenu.Instance.SetDebugString("Json File Does Not Exist");
            }
        }
